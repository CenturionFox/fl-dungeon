...
class JsonDataObject_tests(unittest.TestCase):
...
class EntityType_tests(unittest.TestCase):
    ...
    def test_loadJsonData(self):
        data = pkgutil.get_data("tests","res/entityStatTest.json")
    ...
    def test_loadJsonStream(self):
        d = os.path.dirname(sys.modules["tests"].__file__)
    ...
    def test_entityStatRanges(self):
        data = pkgutil.get_data("tests","res/entityStatRangeTest.json")
        entity = EntityStats(data=data)
